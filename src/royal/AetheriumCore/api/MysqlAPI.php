...
class MysqlAPI{
    ...
    public static function Init(){
        ...
        Main::getInstance()->getServer()->getAsyncPool()->submitTask(new MysqlTask("CREATE TABLE IF NOT EXISTS`Aetherium_Job`.`Farmer` ( `pseudo` TEXT NOT NULL , `xp` INT NOT NULL , `lvl` INT NOT NULL ) ENGINE = InnoDB", "discord_job"));
        Main::getInstance()->getServer()->getAsyncPool()->submitTask(new MysqlTask("CREATE TABLE IF NOT EXISTS`Aetherium_Job`.`Miner` ( `pseudo` TEXT NOT NULL , `xp` INT NOT NULL , `lvl` INT NOT NULL ) ENGINE = InnoDB", "discord_job"));
        Main::getInstance()->getServer()->getAsyncPool()->submitTask(new MysqlTask("CREATE TABLE IF NOT EXISTS`Aetherium_Job`.`Hunter` ( `pseudo` TEXT NOT NULL , `xp` INT NOT NULL , `lvl` INT NOT NULL ) ENGINE = InnoDB", "discord_job"));
